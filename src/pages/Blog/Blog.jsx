...
const Blog = () => {
  return (
    <>
      <div ref={ref} className="md:mt-6 mt-32 p-4 md:px-12">
        <div className="flex text-[#41644A] font-bold gap-3 items-center justify-center">
          ...
          <Pdf x={-20} targetRef={ref} filename="code-example.pdf">
            {({ toPdf }) => (
              <button
                className=" btn bg-green-900 flex items-center gap-2 border rounded-full"
                onClick={toPdf}
              >
                Download{" "}
